...
# Initialize Gemini
genai.configure(api_key='AIzaSyCvqFpRtsXURc3Ez-x5SJ12-kj7ujVKiLg')
model = genai.GenerativeModel('gemini-pro')

# Configure Google OAuth
google = oauth.register(
    name='google',
    client_id='393243841050-16b750c6br48r24ifjd56kf4lfkgmm2b.apps.googleusercontent.com',
    client_secret='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',
...
supabase = create_client(
    'https://epgjswspnvabekynqikd.supabase.co',
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVwZ2pzd3NwbnZhYmVreW5xaWtkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mzk3Mzc5MzIsImV4cCI6MjA1NTMxMzkzMn0.f7yCVm89vAbneYt8ydAVKDhvMuZ2FoIHVAOSoQ4SceQ'
)
...
def load_model():
    ...
    try:
        ...
        repo_id = "aarush12377/emotion_graph"  # Replace with your repository name
        
        # Load tokenizer
        global_tokenizer = AutoTokenizer.from_pretrained("roberta-base")
        
        # Initialize model
        global_model = BERTModel(num_labels=len(emotion_labels))

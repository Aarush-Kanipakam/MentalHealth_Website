...
from app import global_tokenizer,global_model
...
def classify_emotion(text):
    ...
    try:
        # Use global tokenizer and model instead of loading from paths
        device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
        
        # Tokenize and prepare input
        inputs = global_tokenizer(text, return_tensors="pt", truncation=True, padding=True, max_length=128)
